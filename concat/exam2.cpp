...
int main()
{
	...
	img_logo = imread("C:\\Users\\c2eri\\OneDrive\\바탕 화면\\소스코드\\Ch6\\6.3\\logo.png", IMREAD_COLOR);
	img_background = imread("C:\\Users\\c2eri\\OneDrive\\바탕 화면\\소스코드\\Ch6\\6.3\\background.png", IMREAD_COLOR);
